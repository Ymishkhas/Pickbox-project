...
username = 'iHerb_North_Jeddah@pickbox'
...
o = c.execute("select region, store_name from online_store, driver where driver.username = ? and driver.store_id = online_store.store_id", (username,)).fetchall()
print(o)
print(o[0][0])
